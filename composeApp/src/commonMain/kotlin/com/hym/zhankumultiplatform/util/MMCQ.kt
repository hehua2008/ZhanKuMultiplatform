...
class MMCQ(
    ...
    class ThemeColor(val color: Int, val proportion: Double) : Comparable<ThemeColor> {
        ...
        init {
            //Logger.d(TAG, "proportion:" + proportion + " RGB:" + Color.red(color) + " " + Color.green(color) + " " + Color.blue(color))
    ...
    companion object {
                ...
                COLOR_RED -> {
                    ...
                    while (r <= vBox.r2) {
                        ...
                        if (nPixs >= vBox.mNumPixs / 2) {
                            ...
                            //Logger.d(TAG, "VBOX " + vBox1.mNumPixs + " " + vBox2.mNumPixs);
        ...
        private fun iterCut(maxColor: Int, boxQueue: PriorityQueue<VBox>) {
            ...
            while (true) {
                ...
                if (vBox.mNumPixs == 0L) {
                    //Logger.w(TAG, "Vbox has no pixels")
                    //boxQueue.offer(vBox);
                    continue
                }
                ...
                if (nIters >= MAX_ITERATIONS) {
                    //Logger.w(TAG, "Infinite loop; perhaps too few pixels!")
                    break
                }
            }
