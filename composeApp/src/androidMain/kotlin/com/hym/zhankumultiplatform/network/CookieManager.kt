...
import com.hym.zhankumultiplatform.util.HexDump
import com.hym.zhankumultiplatform.util.Logger
import com.hym.zhankumultiplatform.util.StringUtils
...
class CookieManager(private val mContext: Application) : CookieJar {
    override fun saveFromResponse(url: HttpUrl, cookies: List<Cookie>) {
        ...
        try {
            ...
            Logger.w(TAG, "saveFromResponse failed", e)
        }
    }
        ...
        if (cookieSerialize != null) {
            ...
            if (file.isFile) {
                try {
                    ...
                    Logger.w(TAG, "loadForRequest failed", e)
