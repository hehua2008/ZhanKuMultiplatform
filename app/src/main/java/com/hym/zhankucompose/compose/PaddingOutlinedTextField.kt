 ...
 * @param outlinedTextFieldTopPadding this padding is used to allow label not overlap with the
 * content above it.
 */
...
fun PaddingOutlinedTextField(
    ...
    outlinedTextFieldTopPadding: Dp = PaddingOutlinedTextFieldTopPadding
) {
...
*/
/* @VisibleForTesting */
val PaddingOutlinedTextFieldTopPadding = 8.dp
