...
open class AutoScrollLinearLayoutManager : LinearLayoutManager, View.OnLayoutChangeListener {
    ...
    override fun onAttachedToWindow(view: RecyclerView) {
        ...
        mRecyclerView = view.apply {
            addOnLayoutChangeListener(this@AutoScrollLinearLayoutManager)
        }
    }
    ...
    override fun scrollVerticallyBy(dy: Int, recycler: Recycler, state: RecyclerView.State): Int {
        ...
        val parentView = recyclerView?.let { getParentNestedScrollView(it) }
            ?: return super.scrollVerticallyBy(dy, recycler, state)
    ...
    override fun onLayoutChange(
        ...
        val parentView = getParentNestedScrollView(recyclerView) ?: return
        ...
        if (bottomCovered > 0) {
            ...
            recyclerView.scrollBy(0, -min(bottomRemain, bottomCovered))
        }
    }
