 ...
 * @date 2021/8/22
 */
internal class LogListAdapter(private val mLogLevelColorMapper: LogLevelColorMapper) :
    ListAdapter<LogWrapper, LogItemViewHolder>(LogItemDiffCallback) {
    ...
    override fun onBindViewHolder(holder: LogItemViewHolder, position: Int) {
        ...
        val color = mLogLevelColorMapper.map(logWrapper.logLevel)
