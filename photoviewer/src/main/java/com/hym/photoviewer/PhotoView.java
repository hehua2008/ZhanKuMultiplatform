...
public class PhotoView extends View implements OnGestureListener, OnDoubleTapListener,
    ...
    private static final Paint sCropDimPaint = new Paint();
    /** Paint to highlight the cropped portion of the photo */
    private static final Paint sCropPaint = new Paint();
    ...
    public PhotoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.PhotoView, defStyleAttr, defStyleRes);
        mAllowCrop = a.getBoolean(R.styleable.PhotoView_allowCrop, false);
        mFixedHeight = a.getInt(R.styleable.PhotoView_fixedHeight, -1);
        mTransformsEnabled = a.getBoolean(R.styleable.PhotoView_enableImageTransforms, false);
        mMaxInitialScaleFactor = a.getFloat(R.styleable.PhotoView_maxInitialScale, 1f);
        a.recycle();
        initialize();
    }
    ...
    public void bindDrawable(@Nullable Drawable drawable) {
     ...
     */
    public void bindPhoto(@Nullable Bitmap photoBitmap) {
